...
class GenImg:
  ...
  async def anchor(self, keymmd, keyneg, server, config):
    datreq = {"status": "0", "keymmd": keymmd, "keyneg": keyneg, "keyprc": "xoxxox.PrcImg.cnnimg", "server": dicsrv[server], "config": config}
